...
public class DynamicToken {
  ...
  public String getDynamicCode(String key, long systemTime, int invertal) throws Exception {
    ...
    return output(
        String.valueOf(number % 1000000));//对获取到的整型数据进行模运算，再对结果进行补全（长度不够6位，在首位补零）得到长度为6的字符串
  }
  ...
  public static void main(String[] args) {
    DynamicToken dt = new DynamicToken("NSPS45NYIFORLCQEYFEQCFW3FWYPACW7YALPGWW3MLDUJDJGJXKQ");
    try {
